...
gemini -m gemini-3-pro-preview "Analyze the authentication flow"
...
|-------|---------|-------|----------|
| gemini-3-pro-preview | 1M | Medium | Analysis, Review (DEFAULT) |
| gemini-2.5-pro | 1M | Medium | Legacy, use 3-pro-preview instead |
| gemini-2.0-flash | 1M | Fast | Quick tasks only |

### CLI Flags Reference
```bash
-m MODEL      # Select model (e.g., -m gemini-3-pro-preview) - ALWAYS USE THIS
